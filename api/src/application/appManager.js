...
class AppManager {
  constructor(app, io, database) {
    ...
    this.playerManager = new PlayerManager(database, this.statsManager, this.tokenManager);
    
    this.statsController = new StatsController(app, this.statsManager);
    this.mapController = new MapController(app, io, this.mapManager, this.tokenManager);
    this.playerController = new PlayerController(app, io, this.playerManager, this.tokenManager);
  }
}
